...
public class SortPrep {
   ...
   public void prepareToSort() {
      ...
      Runnable r3 = new MergeSorter(values, mid+1, mid+mid2, comp);
      Runnable r4 = new MergeSorter(values, mid+mid2 + 1, values.length - 1, comp);
      ...
      try {
         ...
         MergeSorter.merge(values, mid+1, mid+mid2, values.length - 1, comp);
